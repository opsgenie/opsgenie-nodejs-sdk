...
function alert() {
    ...
    var ops = {
        ...
        count: function (data, config, cb) {
            client.executeHttp('GET', this.baseURL + 'count', data, config, cb);
        },
        /**
        ...
        addTeam: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'team', data, config, cb);
        },
        /**
        ...
        addRecipient: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'recipient', data, config, cb);
        },
        /**
        ...
        addNote: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'note', data, config, cb);
        },
        /**
        ...
        addTags: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'tags', data, config, cb);
        },
        /**
        ...
        addDetails: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'details', data, config, cb);
        },
        /**
        ...
        executeAction: function (data, config, cb) {
            client.executeHttp('POST', this.baseURL + 'executeAction', data, config, cb);
        }
        /**
        ...
        /*attachFile: function (data, config, cb) {
         client.executeHttp('POST', this.baseURL + 'attachFile', data, config, cb);
         }*/
    };
