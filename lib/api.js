...
exports.get = function executeGetRequest(path, data, http_options, cb) {
    ...
    var uri = http_options.host + getPathWithParams(path, data, configuration.default_options.api_key);
...
request.defaults({
    json: true,
    maxAttempts: configuration.default_options.retryCount, // 3 times from conf  // (default) try 5 times
